          ...
          <div className="plan-card">
            <div className="row" style={{ justifyContent: 'space-between', marginBottom: 9 }}>
              <span className="row gap-6" style={{ fontWeight: 600, fontSize: 13.5, whiteSpace: 'nowrap' }}>
                <Icon name="zap" size={15} style={{ color: 'var(--accent)' }} /> Plan Starter
              </span>
            ...
            <div className="row" style={{ justifyContent: 'space-between' }}>
              ...
              <a className="row gap-2" style={{ fontSize: 12.5, fontWeight: 600, color: 'var(--accent-ink)' }} onClick={() => onNav('configuracion')}>Mejorar</a>
            </div>
          </div>
