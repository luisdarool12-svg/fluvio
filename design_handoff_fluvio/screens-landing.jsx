  ...
  return (
    <div className="card card-pad col gap-12" style={{ borderRadius: 'var(--r-lg)' }}>
      <div className="row" style={{ justifyContent: 'space-between' }}>
        <div style={{ width: 44, height: 44, borderRadius: 12, background: 'var(--accent-soft)', color: 'var(--accent-deep)', display: 'grid', placeItems: 'center' }}>
          <Icon name={icon} size={22} />
        </div>
        {badge && <span className="chip" style={{ background: 'var(--accent-soft)', color: 'var(--accent-deep)', fontWeight: 600, fontSize: 12 }}>{badge}</span>}
      </div>
...
function Step({ n, title, body }) {
  return (
    <div className="row gap-16" style={{ alignItems: 'flex-start' }}>
      <div className="display" style={{ fontSize: 17, fontWeight: 700, color: '#fff', background: 'var(--accent)', width: 38, height: 38, borderRadius: 11, display: 'grid', placeItems: 'center', flex: 'none' }}>{n}</div>
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="row" style={{ maxWidth: 1180, margin: '0 auto', padding: '64px 28px 72px', gap: 56, alignItems: 'center', flexWrap: 'wrap' }}>
          <div className="col gap-24" style={{ flex: '1 1 420px', minWidth: 320 }}>
            <span className="chip" style={{ alignSelf: 'flex-start', background: 'var(--accent-soft)', color: 'var(--accent-deep)', fontWeight: 600, height: 32 }}>
            ...
            <h1 style={{ fontSize: 'clamp(40px, 6vw, 62px)', lineHeight: 1.02, letterSpacing: '-0.035em' }}>
              Tu restaurante,<br />siempre lleno.<br /><span style={{ color: 'var(--accent)' }}>Sin esfuerzo.</span>
            </h1>
            ...
            <div className="row gap-20" style={{ marginTop: 4, color: 'var(--ink-3)', fontSize: 13.5, fontWeight: 500, flexWrap: 'wrap' }}>
              <span className="row gap-6"><Icon name="check" size={16} style={{ color: 'var(--accent)' }} /> 14 días gratis</span>
              <span className="row gap-6"><Icon name="check" size={16} style={{ color: 'var(--accent)' }} /> Sin tarjeta</span>
              <span className="row gap-6"><Icon name="check" size={16} style={{ color: 'var(--accent)' }} /> Listo en 5 min</span>
            </div>
          </div>
      ...
      <section id="features" style={{ maxWidth: 1180, margin: '0 auto', padding: '84px 28px' }}>
        <div className="col gap-8" style={{ textAlign: 'center', alignItems: 'center', marginBottom: 48 }}>
          <span className="chip" style={{ background: 'var(--accent-soft)', color: 'var(--accent-deep)', fontWeight: 600 }}>Funciones</span>
        ...
        <div className="row" style={{ maxWidth: 1180, margin: '0 auto', padding: '84px 28px', gap: 64, alignItems: 'center', flexWrap: 'wrap' }}>
          <div className="col gap-28" style={{ flex: '1 1 360px' }}>
            <div className="col gap-8">
              <span className="chip" style={{ alignSelf: 'flex-start', background: 'var(--accent-soft)', color: 'var(--accent-deep)', fontWeight: 600 }}>Así funciona</span>
      ...
      <section id="precio" style={{ maxWidth: 1180, margin: '0 auto', padding: '84px 28px' }}>
        <div style={{ background: 'var(--accent-deep)', borderRadius: 'var(--r-xl)', padding: '56px 40px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="col gap-16" style={{ alignItems: 'center', position: 'relative' }}>
            ...
            <div className="row gap-12" style={{ marginTop: 6 }}>
              <button className="btn btn-lg" style={{ background: '#fff', color: 'var(--accent-deep)' }} onClick={() => onNav('login')}>Empezar gratis</button>
...
function MiniDashPreview() {
  return (
    <div className="card" style={{ width: '100%', maxWidth: 400, overflow: 'hidden', boxShadow: 'var(--shadow-lg)' }}>
