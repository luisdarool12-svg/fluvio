  ...
  return (
    <div className="row" style={{ justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 22, gap: 16, flexWrap: 'wrap' }}>
      <div className="col gap-4">
        ...
        <h1 style={{ fontSize: 30 }}>{greet}, Luis <span style={{ color: 'var(--violet)' }}>👋</span></h1>
  ...
  return (
    <div className="card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div className="row" style={{ justifyContent: 'space-between', padding: '15px 18px 13px', borderBottom: '1px solid var(--line)' }}>
        ...
        <span className="chip" style={{ background: 'var(--violet-light)', color: 'var(--plum)', fontWeight: 600, fontSize: 12 }}>
...
function UpcomingPanel({ onNav }) {
  return (
    <div className="card" style={{ overflow: 'hidden' }}>
      <SectionHead title="Próximas reservas" right={<a className="row gap-2" style={{ fontSize: 13, fontWeight: 600, color: 'var(--violet-ink)' }} onClick={() => onNav('reservaciones')}>Ver todas <Icon name="chevronRight" size={14} /></a>} />
