  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div className="hide-sm" style={{
        flex: '1 1 0', background: 'var(--plum)', position: 'relative', overflow: 'hidden',
        ...
        <div style={{ flex: 1, display: 'grid', placeItems: 'center', padding: '12px 24px 60px' }}>
          <div className="col gap-24" style={{ width: '100%', maxWidth: 380 }}>
            ...
            <form className="col gap-14" onSubmit={submit}>
              ...
              <div className="field">
                <div className="row" style={{ justifyContent: 'space-between' }}>
                  ...
                  {mode === 'login' && <a style={{ fontSize: 13, color: 'var(--violet-ink)', fontWeight: 600 }}>¿Olvidaste?</a>}
                </div>
                <div className="search-wrap">
            ...
            <p className="muted" style={{ textAlign: 'center', fontSize: 14 }}>
              ...
              <a style={{ color: 'var(--violet-ink)', fontWeight: 600 }} onClick={() => setMode(mode === 'login' ? 'signup' : 'login')}>
