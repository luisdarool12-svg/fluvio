  ...
  return (
    <div className="card card-pad col gap-14" style={{ opacity: table.active ? 1 : 0.62 }}>
      <div className="row" style={{ justifyContent: 'space-between' }}>
        <div className="row gap-10">
          <div style={{ width: 42, height: 42, borderRadius: 11, background: 'var(--violet-light)', color: 'var(--plum)', display: 'grid', placeItems: 'center' }}>
  ...
  return (
    <div className="card card-pad" style={{ padding: '20px 24px' }}>
      <div className="row gap-12" style={{ marginBottom: 4 }}>
        <div style={{ width: 38, height: 38, borderRadius: 10, background: 'var(--violet-light)', color: 'var(--plum)', display: 'grid', placeItems: 'center', flex: 'none' }}><Icon name={icon} size={19} /></div>
        <div className="col" style={{ gap: 1 }}>
      ...
      <div className="row gap-6" style={{ marginBottom: 20, borderBottom: '1px solid var(--line)', overflowX: 'auto' }}>
        {tabs.map(([k,l,ic]) => (
          <button key={k} onClick={() => setSection(k)} className="row gap-8"
            style={{ padding: '11px 14px', fontWeight: 600, fontSize: 14, color: section === k ? 'var(--ink)' : 'var(--ink-3)', borderBottom: section === k ? '2px solid var(--violet)' : '2px solid transparent', marginBottom: -1 }}>
      ...
      <div className="col gap-18">
        ...
        {section === 'plan' && (
          <ConfigSection icon="card" title="Plan y facturación" desc="Tu suscripción actual">
            <div className="card" style={{ padding: 18, boxShadow: 'none', background: 'var(--plum)', color: '#fff', marginBottom: 6 }}>
